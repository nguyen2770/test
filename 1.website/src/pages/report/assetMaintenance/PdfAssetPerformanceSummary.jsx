...
const PdfAssetPerformanceSummary = ({ data }) => {
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.headerContainer}>
                    ...
                    <View style={styles.titleContainer}>
                        <Text style={styles.title}>{t("Hiệu suất tài sản")}</Text>
                    </View>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableLabel}>
                            <Text style={styles.bold}>
                                {t("report.assetPerformance.columns_summary.total_assets")}
                            </Text>
                        </View>
                        <View style={styles.tableLabel}>
                            <Text>
                                {checkData(data?.totalAssetmaintenances)}
                            </Text>
                        </View>
                    </View>
                </View>
...
export default PdfAssetPerformanceSummary;