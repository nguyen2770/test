...
const PdfAssetDepreciationSummary = ({ data }) => {
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.headerContainer}>
                    ...
                    <View style={styles.titleContainer}>
                        <Text style={styles.title}>{t("Khấu hao tài sản")}</Text>
                    </View>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableLabel}>
                            <Text style={styles.bold}>
                                {t("report.assetDepreciation.columns.depreciation_start_date")}
                            </Text>
                        </View>
                        <View style={styles.tableCol}>
                            <Text>
                                {checkData(parseDate(data?.depreciationStartDate))}
                            </Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableLabel}>
                            <Text style={styles.bold}>
                                {t("report.assetDepreciation.columns.usage_time")}
                            </Text>
                        </View>
                        <View style={styles.tableCol}>
                            <Text>
                                {checkData(data?.usageTime)}
                            </Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableLabel}>
                            <Text style={styles.bold}>
                                {t("report.assetDepreciation.columns.remaining_time")}
                            </Text>
                        </View>
                        <View style={styles.tableCol}>
                            <Text>
                                {checkData(data?.remainingTime)}
                            </Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                    ...
                    <View style={styles.tableRow}>
                        <View style={styles.tableLabel}>
                            <Text style={styles.bold}>
                                {t("report.assetDepreciation.columns.depreciable_value")}
                            </Text>
                        </View>
                        <View style={styles.tableCol}>
                            <Text>
                                {checkData(formatNumber(data?.depreciableValue))}
                            </Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                        <View style={styles.tableLabel}>
                            <Text style={styles.bold}>
                                {t("report.assetDepreciation.columns.accumulated_value")}
                            </Text>
                        </View>
                        <View style={styles.tableCol}>
                            <Text>
                                {checkData(formatNumber(data?.accumulatedValue))}
                            </Text>
                        </View>
                    </View>
                </View>
...
export default PdfAssetDepreciationSummary;