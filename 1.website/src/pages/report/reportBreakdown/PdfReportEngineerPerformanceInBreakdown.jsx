...
import { assetMaintenanceStatus, assetType, breakdownUserStatus, priorityLevelStatus, progressStatus, ticketStatuOptions } from "../../../utils/constant";
...
const PdfReportEngineerPerformanceInBreakdown = ({ data }) => {
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.headerContainer}>
                    ...
                    <View style={styles.titleContainer}>
                        <Text style={styles.title}>{t("Xử lý sự cố của kỹ sư")}</Text>
                    </View>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={styles.tableCol}>
                            <Text>
                                {t(parseToLabel(breakdownUserStatus.Option, data?.status))}
                            </Text>
                        </View>
                    </View>
                    <View style={styles.tableRow}>
                ...
                <View style={styles.table}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        <View style={styles.tableCol}>
                            <Text>{checkData(data?.breakdown?.createdBy?.fullName)}</Text>
                        </View>
                        <View style={styles.tableCol}>
                            <Text style={styles.bold}>{t("Email")}</Text>
                        </View>
                        <View style={styles.tableCol}>
                            <Text>{checkData(data?.breakdown?.createdBy?.email)}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.table}>
                        ...
                        <View style={styles.tableRow}>
                            <View style={styles.tableLabel}>
                                <Text style={styles.bold}>{t("report.engineerBreakdown.columns.time_used")}</Text>
                            </View>
                            <View style={styles.tableLabel}>
...
export default PdfReportEngineerPerformanceInBreakdown;