...
export default function CreateSpareCategory({ open, handleOk, handleCancel }) {
  ...
  const onFinish = async () => {
    ...
    let res = await _unitOfWork.spareCategory.createSpareCategory(payload);
    if (res) {
      form.resetFields();
      handleOk();
    } else {
      // Giữ nguyên (không thêm message)
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        <Card title={t("spareCategory.create.title")}>
          <Row>
            <Col span={24}>
              <Form.Item
            ...
            <div className="modal-footer">
              ...
              <Button
                ...
                type="primary"
                onClick={() =>
                  Confirm(t("spareCategory.messages.confirm_create"), () =>
                    onFinish()
                  )
                }
              >
