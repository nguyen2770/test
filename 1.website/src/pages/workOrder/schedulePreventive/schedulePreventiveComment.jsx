...
const SchedulePreventiveComment = () => {
    ...
    >
      ...
      <div style={{ borderTop: "1px solid #eee", paddingTop: 12 }}>
        ...
        >
          ...
          <Button onClick={() => navigate(-1)}>{t("preventiveSchedule.buttons.cancel")}</Button>
          <Button
            type="primary"
            icon={<SendOutlined />}
            onClick={handleSend}
...
export default SchedulePreventiveComment;