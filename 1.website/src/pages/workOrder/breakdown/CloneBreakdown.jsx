    ...
    useEffect(() => {
        ...
        if (open && breakdown) {
            ...
            form.setFieldsValue({
                ...
                serviceCategory: breakdown?.serviceCategory?._id || breakdown?.serviceCategory?.id,
                subServiceCategory: breakdown?.subServiceCategory?._id || breakdown?.subServiceCategory?.id,
                ...
                breakdownDefect: breakdown?.breakdownDefect?._id || breakdown?.breakdownDefect?.id,
