...
export default function CreateServiceContractor({
  open,
  handleOk,
  handleCancel,
}) {
  ...
  const onFinish = async () => {
    ...
    let res = await _unitOfWork.serviceContractor.createServiceContractor(
      payload
    );
    if (res && res.code === 1) {
      form.resetFields();
  ...
  return (
    ...
    >
      ...
      >
        <Card title={t("serviceContractor.create.title")}>
          <Row gutter={32}>
            <Col span={12}>
              <Form.Item
          ...
          <Row>
            <div className="modal-footer">
              ...
              <Button key="button" type="primary" htmlType="submit">
                {t("serviceContractor.common.buttons.create")}
              </Button>
            </div>
          </Row>
        </Card>
