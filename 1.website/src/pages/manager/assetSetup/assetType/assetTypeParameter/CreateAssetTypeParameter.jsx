...
export default function CreateAssetTypeParameter({
  open,
  handleCancel,
  assetType,
  onRefresh
  ...
  const onFinish = async () => {
    ...
    let res =
      await _unitOfWork.assetTypeParameter.createAssetTypeParameter({
        ...values,
  ...
  return (
    ...
    >
      <Form form={form} onFinish={onFinish} layout="vertical">
        <Card title={t("assetType.parameter.create.title")}>
          <Row>
            <Col span={24}>
              <Form.Item
                name="name"
            ...
            <Col span={8}>
              <Form.Item
                name="uom"
                label={t("assetType.parameter.create.fields.uom")}
                labelAlign="left"
              >
                <Select
                  allowClear
            ...
            <div className="modal-footer">
              <Button onClick={onCancel}>
                {t("assetType.parameter.create.buttons.close")}
              </Button>
              <Button type="primary" htmlType="submit">
                {t("assetType.parameter.create.buttons.create")}
              </Button>
            </div>
          </Row>
          <CreateUom
